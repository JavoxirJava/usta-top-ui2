...
export default function Footer() {
  ...
  return (
    <footer className="bg-charcoal-950 text-white">
      ...
      <div className="h-1 bg-gradient-to-r from-primary-400 via-primary-500 to-sage-500" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-charcoal-400 max-w-sm mb-6">
              Connecting you with trusted local professionals for all your home
              service needs. Quality work, fair prices, peace of mind.
            </p>
            {/* Social Links */}
            <div className="flex items-center gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-xl bg-charcoal-800 flex items-center justify-center text-charcoal-400 hover:bg-primary-500 hover:text-white transition-all"
                aria-label="Twitter"
              >
